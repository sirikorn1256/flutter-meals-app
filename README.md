...
แอปตัวอย่างที่พัฒนาด้วย **Flutter** สำหรับแสดงเมนูอาหารตามหมวดหมู่ ผู้ใช้สามารถดูรายละเอียดอาหาร และเพิ่มเมนูที่ชอบไว้ใน Favorites ได้

## Features
- แสดงหมวดหมู่อาหาร
- ดูรายการอาหารตามหมวดหมู่
- ดูรายละเอียดอาหาร
- เพิ่มอาหารใน Favorites
...
วิธีแก้  
เพิ่ม parameter `onToggleFavorite` ใน constructor ของ widget และส่งค่าไปตอน navigate ไปยังหน้าอื่น

---

### 3. การ Push โปรเจคขึ้น GitHub ครั้งแรก
ปัญหา  
ตอนแรกยังไม่รู้ขั้นตอนการเชื่อม Git กับ GitHub
